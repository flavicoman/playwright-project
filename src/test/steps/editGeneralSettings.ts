...
Then('user navigates to general settings page', {timeout: 90000}, async function () {
    ...
    await pageFixture.page.locator("(//div[contains(@class,'flex flex-col-reverse')]//input)[1]").type(string);  
    await pageFixture.page.locator("(//div[contains(@class,'flex flex-col-reverse')]//input)[2]").click();
    await pageFixture.page.locator("(//div[contains(@class,'flex flex-col-reverse')]//input)[2]").clear();     
    await pageFixture.page.locator("(//div[contains(@class,'flex flex-col-reverse')]//input)[2]").type(string2); 
    //await new Promise(resolve => setTimeout(resolve, 10000));
    await pageFixture.page.locator("(//div[contains(@class,'flex flex-col-reverse')]//input)[3]").click();
    await pageFixture.page.locator("(//div[contains(@class,'flex flex-col-reverse')]//input)[3]").clear();     
    await pageFixture.page.locator("(//div[contains(@class,'flex flex-col-reverse')]//input)[3]").type(string3); 
    await pageFixture.page.locator("(//label[text()='Website']/following::input)[1]").click();
    await pageFixture.page.locator("(//label[text()='Website']/following::input)[1]").clear();    
    await pageFixture.page.locator("(//label[text()='Website']/following::input)[1]").type(string4); 
    await pageFixture.page.locator("(//label[text()='Address Line 1']/following::input)[1]").click();
    await pageFixture.page.locator("(//label[text()='Address Line 1']/following::input)[1]").clear();     
    await pageFixture.page.locator("(//label[text()='Address Line 1']/following::input)[1]").type(string5); 
    await pageFixture.page.locator("(//label[text()='Address Line 2 (Optional)']/following::input)[1]").click();
    await pageFixture.page.locator("(//label[text()='Address Line 2 (Optional)']/following::input)[1]").clear();     
    await pageFixture.page.locator("(//label[text()='Address Line 2 (Optional)']/following::input)[1]").type(string6);
    await pageFixture.page.locator("(//label[text()='City']/following::input)[2]").click();
    await pageFixture.page.locator("(//label[text()='City']/following::input)[2]").clear();     
    await pageFixture.page.locator("(//label[text()='City']/following::input)[2]").type(string8); 
});
  ...
  Then('user selects new bays : {string}', async function (string) {
    ...
    await pageFixture.page.locator("(//label[text()='Zip']/following::input)[1]").clear();    
